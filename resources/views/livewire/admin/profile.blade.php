            ...
            <div class="profile-tab height-100-p">
                <div class="tab height-100-p">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item">
                            <a wire:click="selecTab('personal_details')"
                                class="nav-link {{ $tab == 'personal_details' ? 'active' : '' }}" data-toggle="tab"
                                href="#personal_details" role="tab">Mes Coordonées</a>
                        </li>
                        <li class="nav-item">
                            <a wire:click="selecTab('update_password')"
                                class="nav-link {{ $tab == 'update_password' ? 'active' : '' }}" data-toggle="tab"
                                href="#update_password" role="tab">Gestion de Mot de passe</a>
                        </li>
                        <li class="nav-item">
                            <a wire:click="selecTab('social_links')"
                                class="nav-link {{ $tab == 'social_links' ? 'active' : '' }}" data-toggle="tab"
                                href="#social_links" role="tab">Les Réseaux Sociaux</a>
                        </li>
                    </ul>
                    <div class="tab-content">

                        <!-- début infos personneles -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                @error('name')
                                                    <span class="text-danger" ml-1 mt-2>{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">{{ __('Adresse Email ') }}</label>
                                                <input type="text" class="form-control" wire:model="email"
                                                    placeholder="Tapez Votre Nom Complet" disabled>
                                                @error('email')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea wire:model="bio" cols="4" rows="4" class="form-control" placeholder="Saisissez Votre Bio"></textarea>
                                                @error('bio')
                                                    <span class="text-danger" ml-1>{{ $message }}</span>
                                                @enderror
                                            </div>
                        ...
                        <!-- fin infos personneles -->

                        <!-- début  gestion de mot de passe  -->
                            ...
                            <div class="pd-20 profile-task-wrap">
                                <form wire:submit="updatePassword()">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">{{ __('Mot de passe actuel') }}</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">{{ __('Confirmer le mot de passe') }}</label>
                                                <input type="password" class="form-control"
