            ...
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                      ...
                      <li>
                        <a href="{{ route('admin.dashboard') }}" class="dropdown-toggle no-arrow">
                            <span class="micon fa fa-th-list"></span><span class="mtext">Services</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon fa fa-newspaper-o"></span><span class="mtext">Articles</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="">New</a></li>
                            <li><a href="">Touts</a></li>
                        </ul>
                    </li>
